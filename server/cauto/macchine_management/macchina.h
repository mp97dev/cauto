...
namespace cauto
{
    ...
    public:
        ...
        void fromJson(const json &j)
        {
            ...
            optionals.fromJson(j.at("optionals"));
        }
        ...
        return json{
            ...
            {"dimensioni", {
                ...
                {"lunghezza", dimensioni.lunghezza},
                {"peso", dimensioni.peso},
                {"volume_bagagliaio", dimensioni.volume_bagagliaio}
            }},
            {"motore", {
                {"tipo", motore.tipo},
                {"alimentazione", motore.alimentazione}
            }},
            {"immagini", {
                {"vista_frontale", immagini.vista_frontale},
                {"vista_laterale", immagini.vista_laterale},
                {"vista_posteriore", immagini.vista_posteriore},
                {"colori", immagini.colori}
            }},
